<?php
//there is class number in generate_number.php, this class is for generate operand or number
include "generate_number.php";
//there is class operator in generate_operator.php, this class is for generate operator, like +, -, or X
include "generate_operator.php";
